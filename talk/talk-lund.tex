...
\uncover<2->{\play\ \ $\ynr$ stretch in $\PNc \to 0$\hspace*{0.9ex}}%
\uncover<3->{\play\ \ precise inferences}
\note<10>[item]{`Bayesian consistency' just like in usual Bayesian inference}
\item<4-> larger $\nzg$ \play\ larger $\PNc$ \hspace*{9ex}\play\ more vague inferences
%\note<10>[item]{larger $\nzg$ as compared to $n$:
%more weight on imprecise prior $\MZ$\\ leads to more imprecise posterior $\MN$}
\item<5-> larger range of $\yzr$ in $\PZc$ \play\ larger range of $\ynr$ in $\PNc$\\ \hspace*{29.25ex}\play\ more vague inferences
